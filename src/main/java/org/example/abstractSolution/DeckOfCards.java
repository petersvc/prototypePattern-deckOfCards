package org.example.abstractSolution;// classe DeckOfCards representa um baralho.
...
public abstract class DeckOfCards
{
   ...
   protected DeckOfCards(DeckOfCards deckOfCards) {
   ...
   @Override
   public abstract DeckOfCards clone();
