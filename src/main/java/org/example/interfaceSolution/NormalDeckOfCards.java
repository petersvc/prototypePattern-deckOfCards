...
public class NormalDeckOfCards implements DeckOfCards, Clonavel
{
    ...
    private NormalDeckOfCards(NormalDeckOfCards normalDeckOfCards)
    {
        this.deck = new ArrayList<Card>();
        this.deck.addAll(normalDeckOfCards.deck);
    ...
    @Override
    public NormalDeckOfCards clonar()
    {
